...
Route::post('/add-wallet-money',['uses'=>'Api\WalletController@creadit']);
Route::get('/wallet-balance/{customer_id}',['uses'=>'Api\WalletController@balance']);
Route::post('/wallet-debit-money',['uses'=>'Api\WalletController@debited']);
Route::get('/wallet-detail/{customer_id}',['uses'=>'Api\WalletController@detail']);
...
Route::get('bus/destination/{source}','Api\BusApiController@get_destination');

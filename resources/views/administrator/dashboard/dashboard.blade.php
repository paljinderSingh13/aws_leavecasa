            ...
            {{-- <div class="row">
                ...
                <div class="col-sm-6 col-lg-4">
                    <div class="panel panel-trans">
                        <div class="panel-heading">
                            <div class="panel-control">
                                <a title="" data-html="true" data-container="body" data-original-title="&lt;p class='h4 text-semibold'&gt;Information&lt;/p&gt;&lt;p style='width:150px'&gt;This is an information bubble to help the user.&lt;/p&gt;" href="javascript:;" class="demo-psi-information icon-lg icon-fw unselectable text-info add-tooltip"></a>
                            </div>
                        ...
                        <div class="bord-top">
                            <ul class="list-group bg-trans bord-no">
                                <li class="list-group-item list-item-sm">
                                    ...
                                    <div class="media-body">
                                        <a href="javascript:;" class="btn-link text-semibold">Facebook</a>
                                    </div>
                                </li>
                                <li class="list-group-item list-item-sm">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <a href="javascript:;" class="btn-link text-semibold">@RalphWe</a>
                                        <br> Design my themes with <a href="javascript:;" class="btn-link text-bold">#Bootstrap</a> Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                                    </div>
                                </li>
                                <li class="list-group-item list-item-sm">
                                    <div class="media-left">
                                    ...
                                    <div class="media-body">
                                        <a href="javascript:;" class="btn-link text-semibold">Ralphz</a>
                                    </div>
                                </li>
                                <li class="list-group-item list-item-sm">
                                    <div class="media-body">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><a href="javascript:;" class="btn-link"> Order #53431</a></td>
                                        ...
                                        <tr>
                                            <td><a href="javascript:;" class="btn-link"> Order #53432</a></td>
                                        ...
                                        <tr>
                                            <td><a href="javascript:;" class="btn-link"> Order #53433</a></td>
                                            <td>Lucy Doe</td>
                                            <td><span class="text-muted">Oct 24, 2014</span></td>
                                            <td>$38.00</td>
                                            <td class="text-center">
                                        ...
                                        <tr>
                                            <td><a href="javascript:;" class="btn-link"> Order #53434</a></td>
                                            <td>Teresa L. Doe</td>
                                        ...
                                        <tr>
                                            <td><a href="javascript:;" class="btn-link"> Order #53435</a></td>
                                            <td>Teresa L. Doe</td>
                                        ...
                                        <tr>
                                            <td><a href="javascript:;" class="btn-link">Order #53437</a></td>
                                            <td>Charles S Boyle</td>
                                        ...
                                        <tr>
                                            <td><a href="javascript:;" class="btn-link">Order #536584</a></td>

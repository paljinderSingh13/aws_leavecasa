        ...
        <div class="navbar-header">
            <a href="index.html" class="navbar-brand">
                <div class="brand-title">
                    <img src="{{asset(env('FPATH').'v2.9/img/logo.png')}}" alt="LeaveCasa Logo" style="margin-left: -15%;">
                </div>
            </a>
        </div>
        <!--================================-->
        ...
        <div class="navbar-content">
            ...
            <ul class="nav navbar-top-links">
                ...
                {{-- <li class="mega-dropdown">
                    <a href="javascript:;" class="mega-dropdown-toggle">
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="javascript:;">Sreen Lock</a></li>
                                    <li><a href="javascript:;">Maintenance</a></li>
                                    <li><a href="javascript:;">Invoice</a></li>
                                    <li><a href="javascript:;" class="disabled">Disabled</a></li>                                        </ul>
                            ...
                            <div class="col-sm-4 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="javascript:;"><span class="pull-right label label-danger">Hot</span>Indox</a></li>
                                    <li><a href="javascript:;">Read Message</a></li>
                                    <li><a href="javascript:;">Compose</a></li>
                            ...
                            <div class="col-sm-4 col-md-3">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="javascript:;" class="media mar-btm">
                            ...
                            <div class="col-sm-12 col-md-3">
                                ...
                                <div class="row img-gallery">
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{asset('v2.9/img/thumbs/img-1.jpg" alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{asset('v2.9/img/thumbs/img-3.jpg" alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{asset('v2.9/img/thumbs/img-2.jpg" alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{asset('v2.9/img/thumbs/img-4.jpg" alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{asset('v2.9/img/thumbs/img-6.jpg" alt="thumbs">
                                    </div>
                                    <div class="col-xs-4">
                                        <img class="img-responsive" src="{{asset('v2.9/img/thumbs/img-5.jpg" alt="thumbs">
                                    </div>
                                </div>
                                <a href="javascript:;" class="btn btn-block btn-primary">Browse Gallery</a>
                            </div>
                        </div>
                    </div>
                </li> --}}
                            ...
                            <div class="nano-content">
                                <ul class="head-list">
                                    ...
                                    <li>
                                        <a class="media" href="javascript:;">
                                            <div class="media-left">
                                                <img class="img-circle img-sm" alt="Profile Picture" src="{{asset(env('FPATH').'v2.9/img/profile-photos/9.png')}}">
                                            </div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <a class="media" href="javascript:;">
                                            <div class="media-left">
                                                <img class="img-circle img-sm" alt="Profile Picture" src="{{asset(env('FPATH').'v2.9/img/profile-photos/3.png')}}">
                                            </div>
                                            <div class="media-body">
                ...
                <li id="dropdown-user" class="dropdown">
                    <a href="javascript:;" data-toggle="dropdown" class="dropdown-toggle text-right">
                        <span class="ic-user pull-right">
                            ...
                            <!--<img class="img-circle img-user media-object" src="{{asset('v2.9/img/profile-photos/1.png')}}" alt="Profile Picture">-->
                            <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                ...
                {{-- <li>
                    <a href="javascript:;" class="aside-toggle">

...
<div class="container">
<center><h4><a class="red-text " href="javascript:login()" class="soap-popupbox modal-trigger">Login</a> /
									<a class="red-text " href="javascript:signup()" class="soap-popupbox">Signup</a></h4></center>
<div class="row">

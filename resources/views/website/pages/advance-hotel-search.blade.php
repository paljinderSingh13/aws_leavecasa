                                ...
                                <span class="card-title icon_prefix" ><i class="material-icons mr-2 search-icon orange-text" style="vertical-align: top;">search</i><b>{{ $no_of_hotels }}</b> results.</span>
                                        ...
                                        <hr class="p-0 mb-10">
                                           ...
                                           <form  action="{{ route('hotels.results') }}" method="post" >
                                                    ...
                                                    <label> <input type="checkbox" class="with-gap" name="stars" value="5"> <span>5 Star </span></label>
                                                    <label><input type="checkbox" class="with-gap" name="stars" value="4"><span>4 Star</span></label>
                                                    <label><input type="checkbox" class="with-gap" name="stars" value="3"><span>3 Star</span></label>
                                                    <label><input type="checkbox" class="with-gap" name="stars" value="2"><span>2 Star</span></label>
                                                    <label><input type="checkbox" class="with-gap" name="stars" value="1"><span>1 Star</span></label>
...
@foreach($h_val['hotels'] as $key => $hotel)
@php
    $mark_price =0;
    if(!empty($hotel['category']))
    {
      $mark_data =  $mark_up->where('star_ratting',$hotel['category'])->toArray();
        if(!empty($mark_data)){
  ...
  @if($loop->iteration%3==0)
    ...
    <div class="col s12 m4" id="h_detail">
      ...
      <img src="{{ url('/images/star/'.$pointrating.'png') }}" width="16" height="16">
      @endif

		...
		<div class=" col col-md-6 bg-white ">
			<div class="panel">
				...
				<div class="panel-body ">
					...
					<form class="login-form lform" method="post" action="<?php echo e(route('login.customer')); ?>">
						<?php echo e(csrf_field()); ?>

						<input type="hidden" name="redirect" value="<?php echo e(route('flight.details')); ?>">
      ...
      <div class="row mt-5 mb-1 justify-content-md-center">
		...
		<div class="panel">
			...
			<div class="panel-body ">
				...
				<form method="post" action="<?php echo e(route('cust.reg')); ?>">
                <?php echo e(csrf_field()); ?>

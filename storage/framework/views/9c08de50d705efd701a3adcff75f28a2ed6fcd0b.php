            ...
            <?php echo Form::open(); ?>
                ...
                <div class="pad-all text-center">
                    <div class="box-inline mar-btm pad-rgt">
                        From :
                        <div class="">
                            <?php echo Form::select('from',\App\Model\IndiaAirportCitiesCode::city_codes(),'ATQ',['class'=>'form-control','placeholder'=>'Select Source']); ?>
                    ...
                    <div class="box-inline mar-btm pad-rgt">
                        To :
                        <div class="">
                            <?php echo Form::select('to',\App\Model\IndiaAirportCitiesCode::city_codes(),'DEL',['class'=>'form-control','placeholder'=>'Select Source']); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="box-inline mar-btm pad-rgt">
                                ...
                                <?php echo Form::text('departure',null,['class'=>'form-control datepicker','placeholder'=>'YYYY-MM-DD','autocomplete'=>'off']); ?>

                            </div>
                            <div class="box-inline mar-btm pad-rgt">
                                <label class="control-label">Arrival Estimate</label>
                                <?php echo Form::text('arrival',null,['class'=>'form-control datepicker','placeholder'=>'YYYY-MM-DD','autocomplete'=>'off']); ?>
